...
class extends Component
{
    ...
    public function feeData()
    {
        ...
        $section = $user->profileable->sections()
            ->active()
            ->first();
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center pb-2">
                        ...
                        <p class="font-semibold text-gray-900">₱{{ number_format($this->feeData['honorarium_total'], 2) }}</p>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200">
                    <div class="flex justify-between items-center">
                        ...
                        <p class="text-lg font-bold text-indigo-600">₱{{ number_format($this->feeData['total_fee'], 2) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 flex flex-col justify-center text-center">
                <div class="inline-flex items-center justify-center w-12 h-12 bg-indigo-100 text-indigo-600 rounded-full mx-auto mb-4">
                ...
                <p class="text-sm text-gray-500 mb-6">Divided equally among {{ $this->feeData['member_count'] }} members</p>
                
                <div class="py-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <p class="text-3xl font-bold text-gray-900">₱{{ number_format($this->feeData['per_student_fee'], 2) }}</p>
                    <p class="text-xs font-medium text-gray-500 mt-1 uppercase tracking-wider">Per Student</p>
                </div>
                
                <p class="text-xs text-gray-400 mt-6">* This is an estimate based on the total group fee divided by current regular members of the group.</p>
            </div>
        </div>
    @endif
</div>
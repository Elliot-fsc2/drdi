...
new #[Title('Research Details')] class extends Component {
    ...
    {
        return ResearchLibrary::with(['group.section.program', 'group.section.semester', 'group.leader', 'group.members', 'group.personnel.instructor', 'group.schedules'])->findOrFail($this->libraryId);
    }
    ...
    public function mount(ResearchLibrary $researchlibrary): void
    {
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium" style="color: #0F172A">
                            {{ $members->count() + ($leader ? 1 : 0) }} students
                        </p>
                    </div>
                    @if ($defense)
                    <div>

...
new #[Title('View Group')] class extends Component implements HasActions, HasSchemas {
    ...
    {
        return $this->group->proposals()->where('status', 'approved')->latest()->get();
    }
            ...
            <div class="lg:col-span-3">
                <div class="bg-white rounded-2xl border overflow-hidden"
                        ...
                        <div class="p-5 sm:p-6">
                            ...
                            @if (count($this->consultations) === 0)
                                <div class="rounded-xl border py-16 flex flex-col items-center text-center"
                                    ...
                                    <p class="text-sm font-semibold mb-1" style="color: #0F172A">No consultations yet
                                    </p>
                                    <p class="text-xs mb-5" style="color: #94A3B8">Schedule your first session with
                                        this group.</p>
                                    <button wire:click="mountAction('scheduleConsultation')"
                                    ...
                                    @foreach ($this->consultations as $consultation)
                                        @php
                                            $statusStyle = match ($consultation['status']) {
                                                ...
                                                'Scheduled'
                                                    => 'background: rgba(0,82,255,0.06); color: #0052FF; border-color: rgba(0,82,255,0.18)',
                                                'Cancelled'
                                                    => 'background: rgba(239,68,68,0.06); color: #DC2626; border-color: rgba(239,68,68,0.18)',
                                                default
                                            ...
                                            <div class="flex items-start justify-between gap-3">
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    @if ($consultation['notes'])
                                                        <div class="mt-3 pt-3 border-t text-xs leading-relaxed"
                                                            style="border-color: #E2E8F0; color: #64748B">
                                                            <span class="font-semibold" style="color: #475569">Notes:
                                                            </span>{{ $consultation['notes'] }}
                                                        </div>
                                                    @endif
                                                </div>
                                                ...
                                                <x-filament::dropdown placement="bottom-end">
                                                    <x-slot name="trigger">
                                                        <button
                                                            ...
                                                            <svg class="h-4 w-4" style="color: #94A3B8"
                    ...
                    @if ($tab === 'proposal')
                        <div class="p-5 sm:p-6">
                            <div class="flex items-center justify-between mb-5">
                                <h3 class="font-bold text-base" style="color: #0F172A">Proposed Research Titles</h3>
                            ...
                            @if ($this->proposals->isEmpty())
                                <div class="rounded-xl border py-16 flex flex-col items-center text-center"
                                    ...
                                    <p class="text-sm font-semibold mb-1" style="color: #0F172A">No proposal submitted
                                    </p>
                                    <p class="text-xs" style="color: #94A3B8">This group hasn't submitted a research
                                        title yet.</p>
                                </div>
                            @else
                                <div class="space-y-4">
                                        ...
                                        <div class="p-[2px] rounded-2xl"
                                            ...
                                            <div class="bg-white rounded-[14px] p-6">
                                                <div class="flex items-start justify-between gap-4 mb-3">
                                                    ...
                                                    <span
                                                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border shrink-0"

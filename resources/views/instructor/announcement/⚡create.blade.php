...
<div>
    <div class="inline-flex items-center gap-2 rounded-full border px-4 py-1.5 mb-5"
        ...
        <span style="font-family: 'JetBrains Mono', monospace; font-size: 11px; letter-spacing: 0.14em; color: #0052FF; text-transform: uppercase">System Broadcast</span>
    </div>
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm" style="color: #64748B">Compose your post below. Rich content options allow you to highlight code snippets, link guidelines, and emphasize notes.</p>
    </div>

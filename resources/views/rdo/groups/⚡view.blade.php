...
new #[Layout('layouts::rdo.app')] #[Title('View Group')] class extends Component {
    public Group $group;
        ...
        <div class="mb-8 sm:mb-10">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-5">
                ...
                <div class="inline-flex items-center gap-1 rounded-xl p-1 shrink-0 flex-wrap"
                    ...
                    @foreach ([['details', 'Details'], ['schedules', 'Schedules']] as [$key, $label])
                        ...
                        <div class="p-5 sm:p-6 space-y-8">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-3">
                                    <h3 class="font-bold text-base" style="color: #0F172A">Members</h3>

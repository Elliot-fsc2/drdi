  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5">
      ...
      <a href="{{ $href }}" wire:key="{{ $tab }}-{{ $group['id'] }}" wire:navigate class="group block h-full">
        ...
        <div
          class="relative p-[2px] rounded-2xl h-full transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-0.5"
          ...
          <div class="bg-white rounded-[14px] overflow-hidden h-full flex flex-col">
            ...
            <div class="px-5 pt-5 pb-4 flex-1">
              ...
              <div class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full mb-4"
                ...
                <span class="w-1.5 h-1.5 rounded-full" style="background: #0052FF; animation: pulse 2s infinite"></span>
                <span
              ...
              <h3
                class="font-bold text-base leading-snug mb-1.5 transition-colors duration-200 group-hover:text-blue-600"
                style="color: #0F172A">
                {{ $group['title'] }}
              </h3>
            ...
            <div class="px-5 py-4 border-t flex items-center justify-between"
              ...
              <div class="transition-transform duration-200 group-hover:translate-x-1" style="color: #93C5FD">
        ...
        {{-- Standard card --}}
        <div
          class="bg-white rounded-2xl border overflow-hidden h-full flex flex-col transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-0.5"
          style="border-color: #E2E8F0">

          {{-- Thin accent stripe --}}
          <div class="h-[3px] w-full transition-opacity duration-300"
            style="background: linear-gradient(to right, #0052FF, #4D7CFF); opacity: 0.25" x-data
          ...
          <div class="px-5 pt-4 pb-4 flex-1 relative overflow-hidden">
            ...
            <h3
              class="font-bold text-base leading-snug mb-1.5 relative transition-colors duration-200 group-hover:text-blue-600"
              style="color: #0F172A">
              {{ $group['title'] }}
            </h3>
          ...
          <div class="px-5 py-4 border-t flex items-center justify-between"
            ...
            <div class="transition-all duration-200 group-hover:translate-x-0.5" style="color: #CBD5E1" x-data
              x-init="$el.parentElement.parentElement.parentElement.addEventListener('mouseenter', () => $el.style.color = '#93C5FD');

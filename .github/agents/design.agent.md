---
name: design-agent
description: UI/UX agent for Laravel Livewire 4 & Tailwind v4. high-contrast, light-only designs.
argument-hint: "a UI component, page section, or styling refactor"
---
<role>
